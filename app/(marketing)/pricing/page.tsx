    ...
    <div className="mx-auto max-w-6xl px-4 py-20 sm:px-6">
      <div className="mx-auto mb-14 max-w-2xl text-center">
        ...
        <p className="mt-4 text-balance text-muted-foreground">
          Every package is a single one-time fee &mdash; no subscriptions,
          no renewals. The earlier your athlete signs up, the lower their
          locked-in annual rate for every year through graduation.
        </p>
      </div>
