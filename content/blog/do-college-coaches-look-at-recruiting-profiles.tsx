  ...
  return (
    <>
      <P>
        ...
        on them? The honest answer is: it depends entirely on how the
      ...
      <P>
        ...
        by state, sport, position, gender, and grad year (the way a
        real search tool should) it becomes a fast way to find
      ...
      <P>
        ...
        platform feel unreliable and unsafe, especially for a site
      ...
      <P>
        ...
        to guess: it&apos;s to see the data. A platform worth paying
      ...
      <UL>
        ...
        <LI>
          ...
          profile, that&apos;s useful information too. It might mean
      ...
      <Callout>
        ...
        views or stars their athlete&apos;s profile. No guessing.{" "}
      ...
      <P>
        Yes, coaches look at recruiting profiles, but only the ones
