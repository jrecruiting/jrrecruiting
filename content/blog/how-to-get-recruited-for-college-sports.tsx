  ...
  return (
    <>
      <P>
        ...
        more parents had when they started: the practical steps that
        actually move the needle, in the order that matters.
      </P>

      <H2>Start earlier than you think you need to</H2>
      <P>
        Coaches at every level (from small NAIA programs to Power
        Conference schools) build their rosters years in advance. That
      ...
      <P>
        ...
        fit, often across dozens of prospects in a single sitting. If
      ...
      <Callout>
        This is exactly the gap J.R. Recruiting was built to close:
      ...
      <H2>Reach out directly: don&apos;t wait to be found</H2>
      <P>
        ...
        short, specific email to a coach or recruiting coordinator
        (including grad year, position, key stats, and a link to film)
      ...
      <P>
        ...
        coach views a profile is useful information: it tells you
      ...
      <P>
        ...
        responsive, and easy to find, not just the ones with the most
